...
class FTemplateMaster {
	 ...
	 * @param booelan $accurate for accurate block parsing
	 */
	 ...
	 *
	 * @param string $varname template var
	 ...
	 *
	 * @param string $varname the name of a variable to load
	 * @param string $filename name to be loaded
	 *
	 * @return void
	 */
	 ...
	 * @param string $varname variable name of the file
	 *
	 ...
	 *
	 * @param string $line one line of the content file
	 * @param string $varname the filename variable identifier
	 * @param string $queued_blocks a list of the current queued blocks
	 * @param string $blocks a list of all identified blocks in the current file
	 *
	 * @return void
	 */
	 ...
	 *
	 * @param array $blocks all identified block names
	 * @return void
	 */
	 ...
	 *
	 * @param string $parent the name of the parent variable
	 * @param string $block the name of the block to be replaced
	 * @return void
	 */
	 ...
	 *
	 * @param string $varname a varname
	 ...
	 *
	 * @param string $varname of the variable to get the value of
	 ...
	 *
	 * @param string $varname name to be cleaned
	 * @return void
	 */
	 ...
	 *
	 * @param string $value be modified
	 * @param $exp
	 * @return unknown_type
	 */
	private function substModifiers($value, $exp) {
		...
		for ($i = 1; $i < sizeof($statements); $i++) {
			...
			$function = $temp[0];
			$parameters = array_diff($temp, array(
					$function 
			));
			$value = call_user_func_array($function, array_merge(array(
					$value 
			), $parameters));
		}
		return $value;
	 ...
	 * content.
	 *
	 * @param string $block block name to be parsed
	 */
